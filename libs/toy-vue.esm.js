    ...
    function patchChildren(n1, n2, container, parentComponent) {
        ...
        if (nextShapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
            ...
            if (prevShapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
                setText(prevEl, "");
                mountChildren(nextChildren, prevEl, parentComponent);
            }
        }
    }
...
export { Fragment, ReactiveEffect, Text, computed, convertToReactive, createApp, createAppApi, createComponentInstance, createRender, createTextVNode, createVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, isTracking, provide, proxyRefs, reactive, readonly, ref, renderSlots, renderer, setCurrentInstance, setupComponent, shallowReadonly, stop, track, trackEffects, trigger, triggerEffects, unRef };
